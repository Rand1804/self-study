...
首先引用`Whynot`大佬高中时的励志名言开场。`Whynot`不仅优秀，努力，还满怀赤诚之心，值得你我作为榜样。

想了许久，也不知道该如何为我这“杂乱无章”的笔记写简介。或许留下我的来时路，对大家有些帮助。
...
课程: [15-213: Introduction to Computer Systems, Sep. 1, 2015](https://scs.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=03308c94-fc20-40d8-8978-1a9b81c344ed)

书籍: "Computer Systems A Programmer’s Perspective-Pearson (2015) - Randal E. Bryant_ David R"
        中文对照：“深入理解计算机系统
...
课程: [6.S081: Operating System Engineering, Fall 2021](https://pdos.csail.mit.edu/6.828/2021/index.html)

书籍: "xv6: a simple, Unix-like teaching operating system"
...
课程： [南京大学 蒋炎岩 操作系统：设计与实现](https://jyywiki.cn/OS/2024/)

书籍："Operating Systems: Three Easy Pieces Arpaci-Dusseau Books, 2018."
...
课程: [CS-340 Intro to Computer Networking](https://www.youtube.com/playlist?list=PLWl7jvxH18r3nnotitKkyAjq268PQGc0-)

书籍: "Computer Networking: A Top-Down Approach"
...
课程：[CMU 15-445/645 :: Intro to Database Systems (Fall 2022)](https://15445.courses.cs.cmu.edu/fall2022/)

书籍："Database System Concepts Seventh Edition Avi Silberschatz Henry F. Korth S. Sudarshan"
...
课程：[MIT 6.824: Distributed Systems (Spring 2020)](http://nil.lcs.mit.edu/6.824/2020/)

书籍："Distributed Systems: Principles and Paradigms" "Distributed Systems, 3rd Edition"
...
课程：[MIT 18.06 Linear Algebra, Spring 2005](https://web.mit.edu/18.06/www/)

书籍："Introduction to Linear Algebra — by Gilbert Strang"


### 概率与统计

课程：[MIT 6.041 Probabilistic Systems Analysis and Applied Probability, Fall 2010](https://ocw.mit.edu/courses/6-041-probabilistic-systems-analysis-and-applied-probability-fall-2010/video_galleries/video-lectures/)

书籍："Introduction to Probability, 2nd Edition by Dimitri P. Bertsekas and John N. Tsitsiklis"


### 微积分

课程：[MIT 18.02 Multivariable Calculus, Fall 2007](https://ocw.mit.edu/courses/18-02-multivariable-calculus-fall-2007/)

书籍："Edwards, Henry C., and David E. Penney. Multivariable Calculus. 6th ed" "18.02 Supplementary Notes and Problems” written by Prof"
